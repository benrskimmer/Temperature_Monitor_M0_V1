...
void SSD1306_begin(uint8_t switchvcc = SSD1306_SWITCHCAPVCC, struct i2c_master_module* hw_module, bool reset);
...
void SSD1306_startvertscroll(uint8_t start, uint8_t stop, bool scrollup); //RSB
